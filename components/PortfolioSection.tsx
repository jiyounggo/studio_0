...
const portfolioItems: PortfolioItem[] = [
  {
    id: 1,
    image: "/images/home/main-visual-01.png",
    alt: "스튜디오 영 포트폴리오 첫 번째",
  },
  {
    id: 2,
    image: "/images/home/main-visual-02.png",
    alt: "스튜디오 영 포트폴리오 두 번째",
  },
  {
    id: 3,
    image: "/images/home/main-visual-03.png",
    alt: "스튜디오 영 포트폴리오 세 번째",
  },
  {
    id: 4,
    image: "/images/home/main-visual-04.png",
    alt: "스튜디오 영 포트폴리오 네 번째",
  },
  {
    id: 5,
    image: "/images/home/main-visual-05.png",
...
export default function PortfolioSection() {
  ...
  return (
    <section
      ref={sectionRef}
      id="portfolio"
      className="relative overflow-hidden bg-[linear-gradient(180deg,#ffffff_0%,#f6f3ff_100%)] py-20 text-black sm:py-24 lg:py-28"
    >
      {/* 배경 장식 */}
      ...
      <div className="pointer-events-none absolute bottom-[-180px] right-[-110px] h-[350px] w-[350px] rounded-full border border-[#6857ef]/10" />
        ...
        <div className="mb-12 flex flex-col justify-between gap-8 border-b-2 border-[#211b47] pb-10 lg:mb-14 lg:flex-row lg:items-end">
          ...
          >
            ...
            <div className="relative mt-1 hidden h-[120px] w-[120px] shrink-0 sm:block lg:h-[135px] lg:w-[135px]">
              ...
              <div className="absolute left-1/2 top-1/2 h-[82px] w-[82px] -translate-x-1/2 -translate-y-1/2 rounded-full border border-[#6857ef]/20 lg:h-[92px] lg:w-[92px]" />
              ...
              <span className="absolute bottom-[15px] left-[18px] h-3 w-3 rounded-full bg-[#6857ef] lg:bottom-[20px] lg:left-[23px]" />

              <Star
                className="absolute right-[14px] top-[24px] h-5 w-5 text-[#6857ef] lg:right-[18px] lg:top-[28px]"
                fill="currentColor"
                strokeWidth={1}
              />
            ...
            <div>
              ...
              <div className="mb-5 flex items-center gap-3 sm:hidden">
                <span className="flex h-10 w-10 items-center justify-center rounded-full border border-black/10">
                  <Star
                    className="h-4 w-4 text-[#6857ef]"
                    fill="currentColor"
                    strokeWidth={1}
                  />
                </span>

                <span className="h-[2px] w-10 bg-[#6857ef]" />
              </div>
          ...
          >
            ...
            <div className="flex shrink-0 gap-2">
              <button
                ...
                aria-label="이전 포트폴리오"
                className="group flex h-12 w-12 items-center justify-center rounded-full border-2 border-[#19152f] bg-white text-[#19152f] transition-all duration-300 hover:bg-[#19152f] hover:text-white"
              >
                <ArrowLeft
              ...
              <button
                ...
                aria-label="다음 포트폴리오"
                className="group flex h-12 w-12 items-center justify-center rounded-full bg-[#6857ef] text-white shadow-[0_8px_22px_rgba(104,87,239,0.22)] transition-all duration-300 hover:bg-[#5948dc]"
              >
                <ArrowRight
                  className="h-5 w-5 transition-transform duration-300 group-hover:translate-x-0.5"
                  strokeWidth={2.3}
      ...
      <div data-reveal data-delay="500" className="portfolio-reveal relative">
        <div className="portfolio-swiper relative ">
          {/* 슬라이드 영역에만 좌우 그라데이션 */}
          <div className="pointer-events-none absolute inset-y-0 left-0 z-20 w-4 bg-gradient-to-r from-[#faf9ff] to-transparent sm:w-10 lg:w-16" />

          <div className="pointer-events-none absolute inset-y-0 right-0 z-20 w-4 bg-gradient-to-l from-[#faf9ff] to-transparent sm:w-10 lg:w-16" />
            ...
            {portfolioItems.map((portfolio, index) => (
              <SwiperSlide key={portfolio.id} className="!h-auto">
                {({ isActive }) => (
                  <div
                    className={[
                      "group relative aspect-[4/5] overflow-hidden rounded-[18px] bg-[#eeeaff]",
                      "border border-[#6857ef]/[0.12]",
                      "transition-all duration-500 ease-out sm:rounded-[22px]",
                      isActive
                        ? "scale-100 opacity-100 shadow-[0_18px_45px_rgba(76,60,170,0.18)]"
                        : "scale-[0.97] opacity-75 shadow-[0_8px_24px_rgba(76,60,170,0.09)]",
                    ].join(" ")}
                  >
                    <Image
                      src={portfolio.image}
      ...
      >
        <div className="flex items-center gap-5">
          ...
          <div className="relative h-[2px] flex-1 overflow-hidden bg-[#6857ef]/10">
            <span
              className="absolute inset-y-0 left-0 bg-[#6857ef] transition-all duration-500"
              style={{
